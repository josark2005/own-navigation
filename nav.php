  ...
  <body>
    ...
    <div class="home view">
      ...
      <div class="nya-container pt">
        ...
        <a href="./<?php echo $dir ?>" class="nya-btn <?php echo $value['mark'] ?? ''; ?> badge" target="_blank" title="<?php echo $value['title']; ?>">
